...
class ServerTests(unittest.TestCase):
    ...
    def test_write_flow(self):
        ...
        status, t = self.req("/api/tasks/T-001/comment", {"message": "Please add tests", "author": "reviewer"})
        self.assertEqual((status, t["comments"][-1]["author"], t["comments_count"]), (200, "reviewer", 1))
        self.assertEqual(self.req("/api/tasks/T-001/comment", {"message": ""})[0], 400)
