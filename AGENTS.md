...
## Developing aiboard itself

- Zero dependencies, Python 3.9+. Run tests with `python3 -m unittest discover -s tests -v`.
- Keep the web page dependency-free too (no CDN assets); it must work offline.
- The block above is generated by `aiboard agents-md`; edit `aiboard/instructions.py`, not this section.
